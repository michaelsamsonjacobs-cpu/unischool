...
export const WebsiteLayout = ({ children, activePage = 'home', onNavigate }) => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#FAF8F5] text-slate-800 font-sans selection:bg-[#8B2332] selection:text-white overflow-x-hidden pb-20">
            {/* Navigation */}
            <nav className="sticky top-0 z-50 bg-[#FAF8F5]/90 backdrop-blur-md border-b border-[#8B2332]/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-20">
                        ...
                        >
                            ...
                            />
                            <div className="hidden h-10 w-10 bg-gradient-to-br from-[#8B2332] to-[#601a25] rounded-lg flex items-center justify-center text-white font-serif font-bold text-xl shadow-lg">
                                U
                            </div>
                            <div>
                        ...
                        {/* Mobile Menu Button */}
                        <button
                            className="md:hidden p-2 text-slate-600 hover:text-[#8B2332]"
            ...
            {/* Global Trust Footer */}
            <footer className="bg-white border-t border-[#8B2332]/10 pt-16 pb-8 relative z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                        <div className="col-span-1 md:col-span-2">
                            <h3 className="font-serif text-2xl font-bold text-[#2D2D2D] mb-4">University School</h3>
                            ...
                            <div className="flex items-start gap-3 p-4 bg-[#8B2332]/5 border border-[#8B2332]/10 rounded-xl max-w-md">
                                <Shield className="text-[#8B2332] flex-shrink-0 mt-1" size={24} />
                                <div>
                                    <h4 className="font-bold text-[#2D2D2D] text-sm mb-1">Academic Supervision</h4>
                                    <p className="text-xs text-slate-600">
                                        All curriculum and learning pathways are independently supervised by administrators from
                                        <span className="text-[#8B2332] font-semibold"> UC Berkeley's Graduate School of Education</span>.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <h4 className="font-semibold text-[#2D2D2D] mb-4">Legal</h4>
                            <ul className="space-y-2 text-sm text-slate-600">
                                <li>Privacy Policy</li>
                                <li>Terms of Service</li>
                                <li>Student Safety</li>
                                <li>Franchise Disclosure (FDD)</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="border-t border-slate-200 pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500">
                        <p>© 2026 University School AI Inc. All rights reserved. "University School" is a registered trademark.</p>
                    </div>
                </div>
            </footer>
        </div>
